...
export default function IdentificationApproval() {
  ...
  const setStatus = async (id, status) => {
    ...
    try {
      ...
      showToast(`Identification ${status.toLowerCase()} successfully`, "success");
    } catch {
      showToast(`Failed to ${status.toLowerCase()} identification`, "error");
    } finally {
    ...
    return (
      <Box sx={{ textAlign: 'center', py: 8 }}>
        ...
        <Typography variant="h5" color="text.secondary" gutterBottom>
          No Pending Identifications
        </Typography>
        <Typography color="text.secondary">
          All identification requests will appear here
        </Typography>
      </Box>
    );
  }
  ...
  return (
    <Box>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography color="text.secondary">
          Review and manage tenant identification documents ({items.length} total)
        </Typography>
      </Box>
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                      ...
                      <Box>
                        <Typography variant="h6" component="h3">
                          {item.responsibleName || 'Unnamed Resident'}
                        </Typography>
